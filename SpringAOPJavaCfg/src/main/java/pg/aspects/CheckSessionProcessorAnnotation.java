...
@Aspect
public class CheckSessionProcessorAnnotation implements AopAspect<CheckSession, String> {
    ...
    public void doAccessCheck(CheckSession checkSession) {
        System.out.printf("CheckSessionProcessorAnnotation.doAccessCheck() required %b\n", checkSession.required());
    ...
    public void doAfterCheck(CheckSession checkSession) {
        System.out.printf("CheckSessionProcessorAnnotation.doAfterCheck() required %b\n", checkSession.required());
    }
    ...
    public void doAfterReturningValueCheck(String retVal, CheckSession checkSession) {
        System.out.printf(
                "CheckSessionProcessorAnnotation.doAfterReturningValueCheck() value [%s] required %b",
    ...
    public void doAfterThrowingCheck(Exception exception, CheckSession checkSession) {
        ...
        System.out.printf("CheckSessionProcessorAnnotation.doAfterThrowingCheck() exception [%s] required %b\n",
